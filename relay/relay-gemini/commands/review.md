---
description: Ask Gemini CLI to review the current diff.
...
- `node "${CLAUDE_PLUGIN_ROOT}/scripts/relay-run.mjs" gemini-companion.mjs run --mode=review --foreground --lifecycle-events markdown --prompt-file "$RELAY_PROMPT_FILE"`
