...
Run `node "${CLAUDE_PLUGIN_ROOT}/scripts/grok-companion.mjs" run --mode adversarial-review --scope branch-diff --scope-base REF --foreground --lifecycle-events markdown --prompt-file "$RELAY_PROMPT_FILE"`.
## Review Contract
