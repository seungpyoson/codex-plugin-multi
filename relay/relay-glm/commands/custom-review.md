...
Run `node "${CLAUDE_PLUGIN_ROOT}/scripts/api-reviewer.mjs" approval-request --provider glm --mode custom-review --scope custom --scope-paths "<file1>,<file2>" --prompt-file "$RELAY_PROMPT_FILE"`.
Run `node "${CLAUDE_PLUGIN_ROOT}/scripts/api-reviewer.mjs" run --provider glm --mode custom-review --scope custom --scope-paths "<file1>,<file2>" --approval-token "<approval_token.value>" --lifecycle-events markdown --prompt-file "$RELAY_PROMPT_FILE"`.
## Review Contract
