...
- `node "${CLAUDE_PLUGIN_ROOT}/scripts/relay-run.mjs" agy-companion.mjs run --mode=custom-review --foreground --lifecycle-events markdown --scope-paths "<file1>,<file2>" --prompt-file "$RELAY_PROMPT_FILE"`
