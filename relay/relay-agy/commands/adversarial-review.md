...
- `node "${CLAUDE_PLUGIN_ROOT}/scripts/relay-run.mjs" agy-companion.mjs run --mode=adversarial-review --foreground --lifecycle-events markdown --prompt-file "$RELAY_PROMPT_FILE"`
