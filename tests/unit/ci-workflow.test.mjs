...
test("pull-request CI runs shared-copy sync checks", () => {
  ...
  assert.match(pkg.scripts["lint:sync"] ?? "", /sync-process-identity\.mjs --check/);
  assert.match(pkg.scripts["lint:sync"] ?? "", /sync-identity\.mjs --check/);
...
test("Sonar CPD excludes intentional packaging and entrypoint copies", () => {
  for (const path of [
    ...
    "plugins/api-reviewers/scripts/lib/process-identity.mjs",
    "plugins/claude/scripts/lib/process-identity.mjs",
    "plugins/gemini/scripts/lib/process-identity.mjs",
    "plugins/grok/scripts/lib/process-identity.mjs",
    "plugins/kimi/scripts/lib/process-identity.mjs",
    ...
    "plugins/api-reviewers/scripts/review-panel.mjs",
    "plugins/api-reviewers/scripts/lib/review-panel.mjs",
    "plugins/claude/scripts/review-panel.mjs",
    "plugins/claude/scripts/lib/review-panel.mjs",
    "plugins/gemini/scripts/review-panel.mjs",
    "plugins/gemini/scripts/lib/review-panel.mjs",
    "plugins/grok/scripts/review-panel.mjs",
    "plugins/grok/scripts/lib/review-panel.mjs",
    "plugins/kimi/scripts/review-panel.mjs",
    "plugins/kimi/scripts/lib/review-panel.mjs",
