...
test("usage-limit helper detects durable quota and billing markers", () => {
  for (const detail of [
    ...
    "No available credits remain for this project.",
    "Monthly spending limit exceeded.",
    "insufficient credits",
    "Error code: 403\nYou've reached your usage limit.",
    "You've hit your session limit · resets 2:50am (operator timezone)",
  ]) {
...
test("usage-limit helper does not classify transient rate or capacity wording", () => {
  for (const detail of [
    ...
    "You have 500 available credits remaining.",
    "Your available credits will reset tomorrow.",
    "You are well under your spending limit.",
    "Your spending limit can be raised in account settings.",
