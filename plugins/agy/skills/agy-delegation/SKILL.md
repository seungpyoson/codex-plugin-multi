---
name: agy-delegation
description: Use when delegating review, adversarial review, custom review, and setup to Google Antigravity CLI.
user-invocable: true
---
...
`<plugin-root>` is `plugins/agy` or an absolute path to that plugin directory. Use skill `relay-agy:agy-delegation`.

Run review:
- `node "<plugin-root>/scripts/agy-companion.mjs" run --mode=review --foreground --lifecycle-events markdown --cwd "<workspace>" --scope-base REF -- "<review focus>"`

Run adversarial review:
- `node "<plugin-root>/scripts/agy-companion.mjs" run --mode=adversarial-review --foreground --lifecycle-events markdown --cwd "<workspace>" --scope-base REF -- "<design or diff to challenge>"`

Run custom-review:
- `node "<plugin-root>/scripts/agy-companion.mjs" run --mode=custom-review --foreground --lifecycle-events markdown --cwd "<bundle-or-workspace>" --scope-paths "PR.diff,docs/*.md" -- "<review focus using relative paths>"`
...
Continue a job:
- `node "<plugin-root>/scripts/agy-companion.mjs" continue --job "<job-id>" --foreground --lifecycle-events markdown --cwd "<workspace>" -- "<follow-up>"`
...
- `node "<plugin-root>/scripts/agy-companion.mjs" cancel --job "<job-id>" --cwd "<workspace>"`

Run setup:
- `node "<plugin-root>/scripts/agy-companion.mjs" doctor --cwd "<workspace>"`
