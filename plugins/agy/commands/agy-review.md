---
description: Ask Google Antigravity CLI to review the current diff.
...
- `node "<plugin-root>/scripts/agy-companion.mjs" run --mode=review --foreground --lifecycle-events markdown -- "<focus text>"`
...
This command backs `plugins/agy/skills/agy-review/SKILL.md`.
