---
description: Ask Google Antigravity CLI to review explicit files.
argument-hint: "--scope-paths <files> [--timeout-ms MS] [focus area]"
...
- `node "<plugin-root>/scripts/agy-companion.mjs" run --mode=custom-review --foreground --lifecycle-events markdown --scope-paths "<file1>,<file2>" -- "<focus text>"`
...
This command backs `plugins/agy/skills/agy-custom-review/SKILL.md`.
