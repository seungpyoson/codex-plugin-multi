---
description: Ask Google Antigravity CLI to challenge the current diff adversarially.
...
- `node "<plugin-root>/scripts/agy-companion.mjs" run --mode=adversarial-review --foreground --lifecycle-events markdown -- "<focus text>"`
...
This command backs `plugins/agy/skills/agy-adversarial-review/SKILL.md`.
