---
description: Ask GLM API to challenge the current branch diff adversarially.
...
Run `node "${CODEX_HOME:-$HOME/.codex}/plugins/cache/codex-plugin-multi/api-reviewers/0.1.0/scripts/api-reviewer.mjs" approval-request --provider glm --mode adversarial-review --scope branch-diff --scope-base REF --prompt "<prompt text>"`.
Run `node "${CODEX_HOME:-$HOME/.codex}/plugins/cache/codex-plugin-multi/api-reviewers/0.1.0/scripts/api-reviewer.mjs" run --provider glm --mode adversarial-review --scope branch-diff --scope-base REF --approval-token "<approval_token.value>" --lifecycle-events markdown --prompt "<prompt text>"`.
## Review Contract
