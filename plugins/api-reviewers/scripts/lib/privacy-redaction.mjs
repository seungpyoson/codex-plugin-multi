...
const AUTHORIZATION_RE = /\bAuthorization:\s*(?:Bearer|Token)?\s*[^\s,;|)]+/gi;
...
export function buildPrivacyRedactor({
  ...
  function text(value) {
    ...
    out = out.replace(AUTHORIZATION_RE, "Authorization: [REDACTED]");
    out = out.replace(BEARER_RE, "Bearer [REDACTED]");
    out = out.replace(TOKEN_RE, "Token [REDACTED]");
    out = out.replace(JWT_SHAPED_TOKEN_RE, REDACTED);
    out = out.replace(ACCOUNT_PAYMENT_TOKEN_RE, REDACTED);
