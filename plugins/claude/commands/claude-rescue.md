...
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=rescue --auth-mode subscription --background --lifecycle-events jsonl -- "$ARGUMENTS"`

For quick attached work, run in the foreground:

- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=rescue --auth-mode subscription --foreground --lifecycle-events jsonl -- "$ARGUMENTS"`
