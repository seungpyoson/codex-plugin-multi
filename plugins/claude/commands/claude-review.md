...
2. Run:
   ```
   node "<plugin-root>/scripts/claude-companion.mjs" run --mode=review --foreground --auth-mode auto --lifecycle-events jsonl -- "<focus text>"
   ```
   ...
   `run --mode=custom-review --auth-mode auto --scope-paths <g1,g2,...>` and
