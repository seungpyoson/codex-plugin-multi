---
description: Ask Claude Code to review the current diff.
...
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=review --auth-mode subscription --foreground --lifecycle-events markdown -- "<focus text>"`
...
This command backs `plugins/claude/skills/claude-review/SKILL.md`.
