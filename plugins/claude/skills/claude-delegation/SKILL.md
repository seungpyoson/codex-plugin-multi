...
description: Use when delegating review, adversarial review, rescue, and setup to Claude Code.
user-invocable: true
---
...
`<plugin-root>` is `plugins/claude` or an absolute path to that plugin directory. Use skill `claude:claude-delegation`.

Run review:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=review --auth-mode subscription --foreground --lifecycle-events jsonl --cwd "<workspace>" --scope-base REF -- "<review focus>"`

Run adversarial review:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=adversarial-review --auth-mode subscription --foreground --lifecycle-events jsonl --cwd "<workspace>" --scope-base REF -- "<design or diff to challenge>"`

Run custom-review:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=custom-review --auth-mode subscription --foreground --lifecycle-events jsonl --cwd "<bundle-or-workspace>" --scope-paths "PR.diff,docs/*.md" -- "<review focus using relative paths>"`

Run rescue:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=rescue --auth-mode subscription --foreground --lifecycle-events jsonl --cwd "<workspace>" -- "<task>"`
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=rescue --auth-mode subscription --background --lifecycle-events jsonl --cwd "<workspace>" -- "<task>"`

Continue a job:
- `node "<plugin-root>/scripts/claude-companion.mjs" continue --auth-mode subscription --job "<job-id>" --foreground --lifecycle-events jsonl --cwd "<workspace>" -- "<follow-up>"`

Cancel a background job:
- `node "<plugin-root>/scripts/claude-companion.mjs" cancel --job "<job-id>" --cwd "<workspace>"`

Run setup:
- `node "<plugin-root>/scripts/claude-companion.mjs" doctor --auth-mode subscription --cwd "<workspace>"`
