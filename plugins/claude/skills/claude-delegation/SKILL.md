...
`<plugin-root>` is `plugins/claude` or an absolute path to that plugin directory. Use skill `relay-claude:claude-delegation`.

Run review:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=review --auth-mode subscription --foreground --lifecycle-events markdown --cwd "<workspace>" --scope-base REF -- "<review focus>"`

Run adversarial review:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=adversarial-review --auth-mode subscription --foreground --lifecycle-events markdown --cwd "<workspace>" --scope-base REF -- "<design or diff to challenge>"`

Run custom-review:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=custom-review --auth-mode subscription --foreground --lifecycle-events markdown --cwd "<bundle-or-workspace>" --scope-paths "PR.diff,docs/*.md" -- "<review focus using relative paths>"`
...
Run rescue:
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=rescue --auth-mode subscription --foreground --lifecycle-events markdown --cwd "<workspace>" -- "<task>"`
- `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=rescue --auth-mode subscription --background --lifecycle-events markdown --cwd "<workspace>" -- "<task>"`
