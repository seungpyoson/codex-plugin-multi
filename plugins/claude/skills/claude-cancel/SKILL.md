...
`<plugin-root>` is `plugins/claude` or an absolute path to that plugin directory. Use skill `relay-claude:claude-cancel`. Command doc: `plugins/claude/commands/claude-cancel.md`.
