...
Run `node "<plugin-root>/scripts/claude-companion.mjs" run --mode=adversarial-review --auth-mode subscription --foreground --lifecycle-events jsonl --cwd "<workspace>" --scope-base REF -- "<focus>"`.
