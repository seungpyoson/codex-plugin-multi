...
`<plugin-root>` is `plugins/claude` or an absolute path to that plugin directory. Use skill `claude:claude-adversarial-review`. Command doc: `plugins/claude/commands/claude-adversarial-review.md`.
