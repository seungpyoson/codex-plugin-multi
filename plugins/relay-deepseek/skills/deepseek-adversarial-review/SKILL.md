...
Use skill `relay-deepseek:deepseek-adversarial-review`. Command doc: `../../commands/deepseek-adversarial-review.md`.
## Entrypoint Contract
...
Run `node "${CODEX_HOME:-$HOME/.codex}/plugins/cache/relay-for-codex/relay-deepseek/0.1.0/scripts/api-reviewer.mjs" run --provider deepseek --mode adversarial-review --scope branch-diff --scope-base REF --approval-token "<approval_token.value>" --lifecycle-events markdown --prompt "<focus>"`.
## Review Contract
