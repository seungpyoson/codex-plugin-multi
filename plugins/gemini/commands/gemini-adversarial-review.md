---
description: Ask Gemini CLI to challenge the current diff adversarially.
...
- `node "<plugin-root>/scripts/gemini-companion.mjs" run --mode=adversarial-review --foreground --lifecycle-events markdown -- "<focus text>"`
...
This command backs `plugins/gemini/skills/gemini-adversarial-review/SKILL.md`.
