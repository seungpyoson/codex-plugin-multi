...
`<plugin-root>` is `plugins/gemini` or an absolute path to that plugin directory. Use skill `gemini:gemini-status`. Command doc: `plugins/gemini/commands/gemini-status.md`.
