...
`<plugin-root>` is `plugins/gemini` or an absolute path to that plugin directory. Use skill `relay-gemini:gemini-result`. Command doc: `plugins/gemini/commands/gemini-result.md`.
