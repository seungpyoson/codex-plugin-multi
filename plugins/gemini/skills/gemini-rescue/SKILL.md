...
Run foreground: `node "<plugin-root>/scripts/gemini-companion.mjs" run --mode=rescue --foreground --lifecycle-events jsonl --cwd "<workspace>" -- "<task>"`.
Run background: `node "<plugin-root>/scripts/gemini-companion.mjs" run --mode=rescue --background --lifecycle-events jsonl --cwd "<workspace>" -- "<task>"`.
