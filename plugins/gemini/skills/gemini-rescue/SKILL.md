---
name: gemini-rescue
description: Use when delegating investigation, fixes, or follow-up rescue work to Gemini CLI.
user-invocable: true
---
...
Run foreground: `node "<plugin-root>/scripts/gemini-companion.mjs" run --mode=rescue --foreground --lifecycle-events markdown --cwd "<workspace>" -- "<task>"`.
Run background: `node "<plugin-root>/scripts/gemini-companion.mjs" run --mode=rescue --background --lifecycle-events markdown --cwd "<workspace>" -- "<task>"`.
