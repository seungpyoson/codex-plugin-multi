...
`<plugin-root>` is `plugins/gemini` or an absolute path to that plugin directory. Use skill `relay-gemini:gemini-adversarial-review`. Command doc: `plugins/gemini/commands/gemini-adversarial-review.md`.
