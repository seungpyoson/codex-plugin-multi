...
//
// Target-specific file: Claude/Gemini display strings diverge, so each plugin
// ships its own copy. Re-sync procedure: diff upstream render.mjs, re-apply
// the substitutions below.
//   Codex → Claude (or Gemini)
//   /codex:NAME → /claude-NAME (or /gemini-NAME) (bare slash-command names)
//   codex resume → claude --resume (or gemini --resume)
//   .codex. → .claude. (or .gemini.) (internal data-shape key)
