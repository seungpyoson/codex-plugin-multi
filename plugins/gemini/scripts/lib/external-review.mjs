...
const NOT_SENT_DISCLOSURE_BY_ERROR = Object.freeze({
  ...
  required_evidence_missing: (provider) => `Selected source content was not sent to ${provider}; the selected source packet was missing evidence required by the review prompt.`,
