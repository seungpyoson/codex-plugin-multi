...
// one place. Dispatcher libraries (`gemini.mjs`) accept a profile object; they
...
// Tools Gemini should never invoke in review/ping mode (hard blocklist,
 ...
 * (`plugins/gemini/config/models.json` at runtime). Returns null when the
