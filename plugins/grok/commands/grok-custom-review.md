...
Replace `<file1>,<file2>` with comma- or newline-separated concrete relative paths; expand globs before running. Render the returned JobRecord, and render
`external_review` before the review result when present. Do not print session
