---
description: Ask Grok CLI to challenge the current branch diff adversarially.
...
Run `node plugins/grok/scripts/grok-companion.mjs run --mode adversarial-review --scope branch-diff --scope-base REF --foreground --lifecycle-events markdown --prompt "<prompt text>"`.
## Review Contract
...
This command backs `plugins/grok/skills/grok-adversarial-review/SKILL.md`.
