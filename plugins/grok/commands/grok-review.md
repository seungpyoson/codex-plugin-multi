...
Run `node plugins/grok/scripts/grok-web-reviewer.mjs run --mode review --scope branch-diff --scope-base REF --foreground --lifecycle-events jsonl --prompt "<prompt text>"`.
## Review Contract
