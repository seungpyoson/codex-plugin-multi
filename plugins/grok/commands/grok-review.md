---
description: Ask Grok Web to review the current branch diff.
...
Run `node plugins/grok/scripts/grok-web-reviewer.mjs run --mode review --scope branch-diff --scope-base REF --foreground --lifecycle-events markdown --prompt "<prompt text>"`.
## Review Contract
