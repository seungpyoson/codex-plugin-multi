---
description: Ask Grok CLI to review the current branch diff.
...
Run `node plugins/grok/scripts/grok-companion.mjs run --mode review --scope branch-diff --scope-base REF --foreground --lifecycle-events markdown --prompt "<prompt text>"`.
## Review Contract
...
This command backs `plugins/grok/skills/grok-review/SKILL.md`.
