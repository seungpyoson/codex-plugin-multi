---
description: Ask GLM API to propose a patch for the current branch diff.
...
Run `node "${CODEX_HOME:-$HOME/.codex}/plugins/cache/relay-for-codex/relay-glm/0.1.0/scripts/api-reviewer.mjs" approval-request --provider glm --mode rescue --scope branch-diff --scope-base REF --prompt "<prompt text>"`.
Run `node "${CODEX_HOME:-$HOME/.codex}/plugins/cache/relay-for-codex/relay-glm/0.1.0/scripts/api-reviewer.mjs" run --provider glm --mode rescue --scope branch-diff --scope-base REF --approval-token "<approval_token.value>" --lifecycle-events markdown --prompt "<prompt text>"`.
...
After a completed GLM rescue proposal, run `node "${CODEX_HOME:-$HOME/.codex}/plugins/cache/relay-for-codex/relay-glm/0.1.0/scripts/api-reviewer.mjs" apply-request --job-id "<rescue_job_id>"`.
Render the apply-request output and request explicit approval with its `recommended_tool_justification`.
Only after approval, run `node "${CODEX_HOME:-$HOME/.codex}/plugins/cache/relay-for-codex/relay-glm/0.1.0/scripts/api-reviewer.mjs" apply --job-id "<rescue_job_id>" --approval-token "<approval_token.value>"`.
...
This command backs `../skills/glm-rescue/SKILL.md`.
