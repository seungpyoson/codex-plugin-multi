...
- `node "<plugin-root>/scripts/kimi-companion.mjs" run --mode=adversarial-review --foreground --lifecycle-events markdown -- "<focus text>"`
...
This command backs `plugins/kimi/skills/kimi-adversarial-review/SKILL.md`.
