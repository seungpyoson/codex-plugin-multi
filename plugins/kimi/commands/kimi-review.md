---
description: Ask Kimi Code CLI to review the current diff.
...
- `node "<plugin-root>/scripts/kimi-companion.mjs" run --mode=review --foreground --lifecycle-events markdown -- "<focus text>"`
...
This command backs `plugins/kimi/skills/kimi-review/SKILL.md`.
