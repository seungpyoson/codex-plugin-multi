...
const SOURCE = path.join(REPO_ROOT, "scripts/lib/privacy-redaction.mjs");
...
if (failures.length > 0) {
  process.stderr.write(`error: privacy-redaction packaging copies are stale: ${failures.join(", ")}\n`);
  process.exit(1);
}
