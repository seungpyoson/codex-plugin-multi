...
const SOURCE = path.join(REPO_ROOT, "scripts/lib/provider-route-policy.mjs");
...
if (failures.length > 0) {
  process.stderr.write(`error: provider-route-policy packaging copies are stale: ${failures.join(", ")}\n`);
  process.exit(1);
}
