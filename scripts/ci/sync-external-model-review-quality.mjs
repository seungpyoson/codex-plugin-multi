...
const SOURCE = path.join(REPO_ROOT, "scripts/lib/external-model-review-quality.mjs");
...
if (failures.length > 0) {
  process.stderr.write(`error: external-model-review-quality packaging copies are stale: ${failures.join(", ")}\n`);
  process.exit(1);
}
